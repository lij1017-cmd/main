...
from run_backtest_equity2025新_2 import Backtester, clean_data, calculate_metrics, calculate_win_rate
...
# ==========================================
OUTPUT_EXCEL = 'trendstrategy_results_equity2025新-2.xlsx'
...
# ==========================================
OUTPUT_MD = 'reproduce_report_equity2025新-2.md'
md_content = f"""# Asset Class Trend Following 策略回測報告 (equity2025新-2)
...
# 讀取回測原始碼並移除 __main__ 區塊，以利整合進 Notebook
with open('run_backtest_equity2025新_2.py', 'r', encoding='utf-8') as f:
...
# 建立 Notebook 各個儲存格
nb.cells.append(nbf.v4.new_markdown_cell("# Asset Class Trend Following 策略回測 (equity2025新-2)"))
...
# 儲存 Notebook 檔案
with open('trendstrategy_equity2025新-2.ipynb', 'w', encoding='utf-8') as f:
    nbf.write(nb, f)
