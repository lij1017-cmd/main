...
def main():
    ...
    multipliers = np.arange(1.5, 3.6, 0.1)

    print(f"Starting Dense Grid Search for Multiplier on Training Set ({TRAIN_START} to {TRAIN_END})...")
    ...
    results_df.to_csv('multiplier_plateau.csv', index=False)
    print("\nResults saved to multiplier_plateau.csv")
