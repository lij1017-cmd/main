...
# We'll use more stocks (top 40) now that the limit is 10MB
...
output_filename = 'trendstrategy_formulas_equity25-4.xlsx'
...
for r in range(2, num_rows):
    excel_row = r + 1
    # RebalanceDay (always on col C for simplicity)
...
# Performance Sheet (Up to 2000 trades)
