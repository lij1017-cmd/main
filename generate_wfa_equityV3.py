...
# =============================================================================
# 函式：資料清洗與預處理 (針對 樣本集-1.xlsx 資料格式)
# =============================================================================
...
class Backtester:
    ...
    def run(self, sma_period, roc_period, stop_loss_pct, rebalance_interval, start_date, end_date):
        ...
        # 緩衝期：303日均線需至少303天數據。設定基準點確保再平衡日期不位移。
...
if __name__ == "__main__":
    DATA_FILE = '樣本集-1.xlsx' # 指定使用 樣本集-1.xlsx
    SMA_PERIOD = 303
    ROC_PERIOD = 14
    ...
    OUTPUT_FILE = 'walk-forward-equityV3.xlsx' # 指定 V3 檔名
