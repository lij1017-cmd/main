        ...
        for i in range(loop_start, last_idx + 1):
            ...
            if (i - loop_start) % int(rebalance_interval) == 0:
                ...
                for idx in sorted_all:
                    ...
                    # ADDITIONAL FILTER: ROC must be significant?
                    if current_prices[idx] > sma[i][idx] and roc[i][idx] > 0.05: # ROC > 5%
                        top_3.append(idx)
                ...
                for sig in new_signals:
                    ...
                    if shares > 0:
                        surplus_pool -= (shares * buy_p_exec * 1.001425)
                        for s_id in range(3):
