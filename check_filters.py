...
if __name__ == "__main__":
    ...
    # Check if a simple small capital strategy works to lower MDD
    # (Not allowed by rules but for research)
    # Let's try 100% Cash Filter: if more than X assets are below SMA, go to cash.
    print("Trying ROC filter...")
    for roc_min in [0.05, 0.10]:
         # Modified logic check (internal)
         pass
